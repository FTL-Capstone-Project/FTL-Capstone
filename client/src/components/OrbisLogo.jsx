...
const OrbisLogo = ({ height = 32, markOnly = false }) => {
  ...
  // Both PNGs are now tight-cropped to the wordmark (near-identical ~3.5 aspect ratios;
  // the dark export shipped with transparent padding, which we trimmed to match), so a
  // plain fixed height + auto width renders them the same visual size in both themes.
  return (
    <img
